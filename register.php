      ...
      <div class="col-md-8" id="signup_msg">
        ...
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form id="signup_form" action="backend/register.php" method = "POST" class="was-validated">
              ...
              <div class="form-group">
                <input type="text" name="mobile" class="form-control field-border" placeholder="phone" required>
              </div>
